...
//   const postIndex = postss.findIndex((p) => p.id === postId);

//   // if (postIndex !== -1) {
//   //   postss[postIndex].title = req.body.title; // Update title
//   //   postss[postIndex].description = req.body.description; // Update description
